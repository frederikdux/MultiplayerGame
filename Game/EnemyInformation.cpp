...
EnemyInformation::EnemyInformation(int id, std::string name, sf::Vector2f position, sf::Vector2f velocity, float rotation) {
    this->id = id;
    this->name = name;
...
void EnemyInformation::setRotation(float rotation) {
    this->rotation = rotation;
}

float EnemyInformation::getRotation() {
